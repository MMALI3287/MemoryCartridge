 ...
 * @author USER
 */
public class MemoryCartridgeController implements Initializable {
    ...
    private void createCardAction(ActionEvent event) {
         try {
            System.out.println("Create Card Window Opening!");
    ...
    private void playCardAction(ActionEvent event) {
         System.out.println("Play Card Window Opening");
